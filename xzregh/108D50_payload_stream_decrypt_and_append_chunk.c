// /home/kali/xzre-ghidra/xzregh/108D50_payload_stream_decrypt_and_append_chunk.c
// Function: payload_stream_decrypt_and_append_chunk @ 0x108D50
// Calling convention: __stdcall
// Prototype: BOOL __stdcall payload_stream_decrypt_and_append_chunk(key_payload_t * payload, size_t payload_size, global_context_t * ctx)
...
BOOL payload_stream_decrypt_and_append_chunk
               (key_payload_t *payload,size_t payload_size,global_context_t *ctx)

{
  ...
  if (payload == (key_payload_t *)0x0) {
    ...
    if ((0x12 < payload_size) && ((uint)ctx->payload_state < 2)) {
      ...
      decrypt_success = secret_data_decrypt_with_embedded_seed((u8 *)&payload_keystream_seed,ctx);
      if (decrypt_success != FALSE) {
        ...
        decrypt_success = chacha20_decrypt((u8 *)ciphertext_cursor,inl,(u8 *)&payload_keystream_seed,(u8 *)&hdr,
