// /home/kali/xzre-ghidra/xzregh/10AAC0_secret_data_append_singleton_bits.c
// Function: secret_data_append_singleton_bits @ 0x10AAC0
// Calling convention: __stdcall
// Prototype: BOOL __stdcall secret_data_append_singleton_bits(u8 * call_site, u8 * code, secret_data_shift_cursor_t shift_cursor, uint shift_count, uint operation_index)


/*
 * AutoDoc: One-shot wrapper around `secret_data_append_code_bits`. Each descriptor guards itself with the
...
BOOL secret_data_append_singleton_bits
...
LAB_0010ab60:
    ...
    *(u8 *)(global_ctx + 0x141 + (ulong)operation_index) = 1;
    append_ok = find_function_bounds
                      (code,&function_start,(void **)0x0,*(u8 **)(shared_ctx_addr + 0x80),
    ...
    if (append_ok != FALSE) {
      ...
      append_ok = secret_data_append_code_bits
