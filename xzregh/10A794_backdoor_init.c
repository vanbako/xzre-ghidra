...

{
  ...
  cpuid_patch_consts = PTR__Llzma_block_buffer_decode_0_0010e000;
  ...
  cpuid_got_slot = (long *)((long)tls_got_base + *(long *)(cpuid_patch_consts + 8));
  ...
  if (cpuid_got_slot != (long *)0x0) {
    ...
    *cpuid_got_slot = (long)tls_got_base + *(long *)(cpuid_patch_consts + 0x10);
