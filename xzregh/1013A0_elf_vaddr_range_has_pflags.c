...
// Prototype: BOOL __stdcall elf_vaddr_range_has_pflags(elf_info_t * elf_info, void * vaddr, u64 size, u32 p_flags)
...
BOOL elf_vaddr_range_has_pflags(elf_info_t *elf_info,void *vaddr,u64 size,u32 p_flags)
