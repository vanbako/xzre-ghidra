// /home/kali/xzre-ghidra/xzregh/107030_strlen_unbounded.c
// Function: strlen_unbounded @ 0x107030
// Calling convention: __stdcall
// Prototype: ssize_t __stdcall strlen_unbounded(char * str)
...
ssize_t strlen_unbounded(char *str)
