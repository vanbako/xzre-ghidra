// /home/kali/xzre-ghidra/xzregh/107BC0_sshd_find_socket_fd_by_shutdown_probe.c
// Function: sshd_find_socket_fd_by_shutdown_probe @ 0x107BC0
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_find_socket_fd_by_shutdown_probe(int * pSock, int socket_index, libc_imports_t * imports)
...
BOOL sshd_find_socket_fd_by_shutdown_probe(int *pSock,int socket_index,libc_imports_t *imports)
