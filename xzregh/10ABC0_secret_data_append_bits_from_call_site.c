// /home/kali/xzre-ghidra/xzregh/10ABC0_secret_data_append_bits_from_call_site.c
// Function: secret_data_append_bits_from_call_site @ 0x10ABC0
// Calling convention: __stdcall
// Prototype: BOOL __stdcall secret_data_append_bits_from_call_site(secret_data_shift_cursor_t shift_cursor, uint shift_count, uint operation_index, BOOL bypass)
...
BOOL secret_data_append_bits_from_call_site
...

{
  ...
  // AutoDoc: Pass NULL for `call_site` so `secret_data_append_singleton_bits` starts scanning after the caller; the RET address doubles as the code pointer.
