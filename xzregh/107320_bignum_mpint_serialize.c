// /home/kali/xzre-ghidra/xzregh/107320_bignum_mpint_serialize.c
// Function: bignum_mpint_serialize @ 0x107320
// Calling convention: __stdcall
// Prototype: BOOL __stdcall bignum_mpint_serialize(u8 * buffer, u64 bufferSize, u64 * pOutSize, BIGNUM * bn, imported_funcs_t * funcs)
...
BOOL bignum_mpint_serialize
               (u8 *buffer,u64 bufferSize,u64 *pOutSize,BIGNUM *bn,imported_funcs_t *funcs)
    ...
    if (((funcs->BN_num_bits != (pfn_BN_num_bits_t)0x0) &&
      ...
      if ((long)written_bytes == value_len_bytes) {
        ...
        if ((char)buffer[5] < '\0') {
          ...
          memmove_overlap_safe((char *)(buffer + 4),(char *)(buffer + 5),value_len_bytes);
        }
