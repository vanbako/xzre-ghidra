// /home/kali/xzre-ghidra/xzregh/1081D0_secret_data_decrypt_with_embedded_seed.c
// Function: secret_data_decrypt_with_embedded_seed @ 0x1081D0
// Calling convention: __stdcall
// Prototype: BOOL __stdcall secret_data_decrypt_with_embedded_seed(u8 * output, global_context_t * ctx)
...
BOOL secret_data_decrypt_with_embedded_seed(u8 *output,global_context_t *ctx)

{
  ...
  if ((ctx != (global_context_t *)0x0) &&
    ...
    decrypt_ok = chacha20_decrypt(seed_key_buf.encrypted_seed + 0x20,0x30,
    ...
    if (decrypt_ok != FALSE) {
      ...
      decrypt_ok = chacha20_decrypt(ctx->encrypted_secret_data,0x39,seed_block,payload_iv,output,
                               ctx->imported_funcs);
