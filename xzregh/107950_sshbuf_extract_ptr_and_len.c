// /home/kali/xzre-ghidra/xzregh/107950_sshbuf_extract_ptr_and_len.c
// Function: sshbuf_extract_ptr_and_len @ 0x107950
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshbuf_extract_ptr_and_len(sshbuf * buf, global_context_t * ctx, void * * p_sshbuf_d, size_t * p_sshbuf_size)
...
BOOL sshbuf_extract_ptr_and_len
               (sshbuf *buf,global_context_t *ctx,void **p_sshbuf_d,size_t *p_sshbuf_size)
  ...
  if (((buf != (sshbuf *)0x0) && (p_sshbuf_d != (void **)0x0)) && (p_sshbuf_size != (size_t *)0x0))
  {
    ...
    if (probe_ok != FALSE) {
      ...
      *p_sshbuf_size = sshbuf_span;
      ...
      probe_ok = is_range_mapped_via_pselect(sshbuf_data,sshbuf_span,ctx);
