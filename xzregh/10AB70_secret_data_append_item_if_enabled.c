// /home/kali/xzre-ghidra/xzregh/10AB70_secret_data_append_item_if_enabled.c
// Function: secret_data_append_item_if_enabled @ 0x10AB70
// Calling convention: __stdcall
// Prototype: BOOL __stdcall secret_data_append_item_if_enabled(secret_data_shift_cursor_t shift_cursor, uint operation_index, uint shift_count, int index, u8 * code)
...
BOOL secret_data_append_item_if_enabled
...

{
  ...
  if (index != 0) {
    appended = secret_data_append_singleton_bits(code,code,shift_cursor,shift_count,operation_index);
    return appended;
  }
