...
// Prototype: Elf64_Rela * __stdcall elf_find_rela_reloc(elf_info_t * elf_info, void * target_addr, u8 * slot_lower_bound, u8 * slot_upper_bound, ulong * resume_index_ptr)
...
Elf64_Rela *
elf_find_rela_reloc(elf_info_t *elf_info,void *target_addr,u8 *slot_lower_bound,u8 *slot_upper_bound
