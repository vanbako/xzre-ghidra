// /home/kali/xzre-ghidra/xzregh/10A880_encoded_string_id_lookup.c
// Function: encoded_string_id_lookup @ 0x10A880
// Calling convention: __stdcall
// Prototype: EncodedStringId __stdcall encoded_string_id_lookup(char * string_begin, char * string_end)
...
EncodedStringId encoded_string_id_lookup(char *string_begin,char *string_end)

{
  ...
  logged_probe = secret_data_append_bits_from_addr_or_ret((void *)0x0,(secret_data_shift_cursor_t)0xa,8,1);
  if (logged_probe != FALSE) {
    ...
    for (; (string_begin <= max_scan && (current_char = *string_begin, -1 < (char)current_char));
      ...
      if (current_char < 0x40) {
        ...
        child_rank = popcount_u64(*bitmap_pair);
      }
