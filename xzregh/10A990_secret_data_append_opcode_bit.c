 ...
 * budget tracked inside `secret_data_shift_cursor_t`, reads the normalized opcode from `dctx->opcode_window_dword`, filters out MOV/CMP plus a small ALU opcode mask,
...

{
  ...
  if (bit_index < 0x1c8) {
    ...
    if (((decoded_opcode != 0x109) && (decoded_opcode != 0xbb)) &&
       ((0x2e < decoded_opcode - 0x83 || ((0x410100000101U >> ((byte)(decoded_opcode - 0x83) & 0x3f) & 1) == 0)))) {
