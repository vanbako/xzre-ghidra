...

{
  ...
  if (telemetry_ok != FALSE) {
    ...
    mask_register_bitmap.raw_value = CONCAT22(mask_register_bitmap.words.high_word,mask_register_bitmap.fields.allowed_regs) | X86_REG_MASK_RDI;
    output_register_bitmap.fields.allowed_regs = output_register_bitmap.fields.allowed_regs | X86_REG_MASK_RCX;
