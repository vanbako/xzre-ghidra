...
| `106F30_backdoor_init_stage2` | `loader_rt` | 2 | 2025-11-26 (LR4 revisit) – Captured the shared-globals seeding + `lzma_check_init()` bootstrap, renamed the retry-context temps away from `extraout_*`, and added inline anchors for the seeded pointer hand-off plus the cpuid leaf 0/1 fallback. |
