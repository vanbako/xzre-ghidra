...
| `105830_backdoor_setup` | `loader_rt` | 2 | 2025-11-25 (LR4) – Renamed the hooks/log-handler locals, documented the mm auth-log/PAM/root heuristics plus the secret_bits/audit gate, refreshed the AutoDoc text, and reran the pipeline for the new inline anchors. |
